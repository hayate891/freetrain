...
namespace nft.framework
{
	...
	public class WebLoader
	{
		...
		public FileInfo Load(string destDir)
		{
			...
			{
				Debug.WriteLine(e);
				string templ = Main.resources["webloader.web_exception"].stringValue;
			...
			{
				Debug.WriteLine(e);
				string templ = Main.resources["webloader.other_exception"].stringValue;
