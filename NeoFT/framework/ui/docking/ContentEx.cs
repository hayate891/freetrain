...
//			if(base._autoHidden==true)
//				base.DockingManager.ToggleContentAutoHide(this);
		}
		/// <summary>
		...
		protected internal virtual void OnShown() {
			if(shown!=null)
				shown();
			base.ParentWindowContent.ShowDetails();
		}

		public bool autoHide 
		{
			get{ return base._autoHidden; } 
			set{ 
				if(base._autoHidden!=value)
					base.DockingManager.ToggleContentAutoHide(this);
			}
		}
