...
namespace freetrain.framework
{
	...
	public sealed class ErrorMessageBox : System.Windows.Forms.Form
	{
		...
		private ErrorMessageBox( string caption, Exception e ) {
			...
			detail.Text = e.Message + "Å_n" + e.StackTrace;

			while(true) {
				e = e.InnerException;
				if(e==null)		break;

				detail.Text = detail.Text + "Å_n" + e.Message + "Å_n" + e.StackTrace;
			}
		...
		private void InitializeComponent()
		{
			...
			this.msg.TabIndex = 1;
			this.msg.Text = "ÉGÉâÅ[Ç™î≠ê∂ÇµÇ‹ÇµÇΩ";
			// 
			// linkLabel1
			// 
			...
			this.linkLabel1.TargetUrl = "http://www.kohsuke.org/freetrain/wiki/pukiwiki.php?%A5%D0%A5%B0%CA%F3%B9%F0%A4%CE" +
				"%BC%EA%BD%E7";
			this.linkLabel1.Text = "ÉoÉOÇïÒçêÇ∑ÇÈ";
